...
//sjekker om brukeren er innlogget, hvis ikke routes til login via minside:
...
if(isset($_POST['login']))
{
  ...
  $check_user = $conn->query("select brukernavn, passord from tabel_name WHERE brukernavn='$brukernavn'");
      ...
      <div class="row">
          <div class="col-md-4 col-md-offset-4">
              <div class="login-panel panel panel-success">
                  ...
                  <center><h2 class="panel-title"><a href="home.php"><strong>Bilklubben AS</strong></a></h2><br></center>
                  ...
                  <div class="panel-body">
                      ...
                      <center><b>Vil registrere deg?</b> <br></b><a href="registrering.php">Registrer deg her</a></center>
                  </div>
              </div>
          </div>
      </div>
